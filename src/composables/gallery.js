...
// `useGalleryData.js` used to be byte-identical local copies of what calligraphy
...
// legacy project key, no UUID — calligraphy shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (calligraphy-data 1.0.11+), an outside
