...
export default {
  ...
  home: {
    title: 'calligraphy.identity.title',
    intro: 'calligraphy.home.intro',
    cards: [
      {
        title: 'calligraphy.nav.catalogue',
        description: 'calligraphy.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'calligraphy.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'calligraphy.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'calligraphy.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'calligraphy.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'calligraphy.partnerObjects.emptyPartner',
  //         emptyInstitution: 'calligraphy.partnerObjects.emptyInstitution',
  //         institutionSummary: 'calligraphy.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'calligraphy.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'calligraphy.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
