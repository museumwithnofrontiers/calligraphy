...
The **Museum With No Frontiers — Calligraphy** gallery, built from the published
dataset `@museumwnf/calligraphy-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/calligraphy-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/calligraphy/> through the reusable workflows in
